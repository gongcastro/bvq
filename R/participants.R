#### bvq_participants: Update participant database ##############################
...
#'  the versions of BVQ.
#' @return A data frame (actually, a \code{\link[tibble]{tibble}}) with all participants that have participated or are candidates to participate in any of the versions of BVQ. Each row corresponds to a questionnaire response and each column represents a variable. The output includes the following variables:
#'  \describe{
...
#'      \item{randomisation}{a character string indicating the specific list of items a participant was assigned to. Only applies in the case of short versions of BVQ, such as BL-Short, BL-Short-2 or BL-Lockdown, where the list of items was partinioned into several versions.}
