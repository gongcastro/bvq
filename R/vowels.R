#' Inventory and classification of vowels in X-SAMPA and IPA formats.
#'
...
#' * openness: `"Close"`, `"Near-close"`, `"Near-mid"`, `"Close-mid"`, `"Mid"`, `"Open-mid"`, `"Near-open"`, or `"Open"`. "An open vowel is a vowel sound in which the tongue is positioned as far as possible from the roof of the mouth. Open vowels are sometimes also called low vowels (in U.S. terminology [1]) in reference to the low position of the tongue."^[https://en.wikipedia.org/wiki/Open_vowel#:~:text=An%20open%20vowel%20is%20a,low%20position%20of%20the%20tongue.]
#' * frontness: `"Back`, `"Central`, or `"Front`. "A front vowel is a class of vowel sounds used in some spoken languages, its defining characteristic being that the highest point of the tongue is positioned as far forward as possible in the mouth without creating a constriction that would otherwise make it a consonant. Front vowels are sometimes also called bright vowels because they are perceived as sounding brighter than the back vowels."^[https://en.wikipedia.org/wiki/Front_vowel]
"vowels"