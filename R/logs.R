...
#' @param responses Responses data frame, as generated by \code{\link{bvq_responses}}.
#'  If NULL (default), \code{\link{bvq_responses}} is run.
#' @param participants Participants data frame, as generated by \code{\link{bvq_participants}}.
#'  If NULL (default), \code{\link{bvq_participants}} is run.
