...
process_survey <- function(raw, participants_tmp, version) {
  ...
  items_to_keep <- c(
    "child_id", "response_id", "time", "version", "version_list",
  ...
  processed <- raw_tmp %>%
    ...
    mutate(
      ...
      across(
        c(
          child_id, response_id, version, version_list,
    ...
    relocate(
      child_id, response_id, time, version, version_list, item, response, language,
