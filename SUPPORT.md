...
Thanks for using bvq! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/gongcastro/bvq/issues/new).
...
requests](https://github.com/gongcastro/bvq/issues) to make sure the bug
